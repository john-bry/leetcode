...
def test_solution():
    ...
    s4 = "ac"
    expected4 = "a"  # or "c"
    result4 = solution.longest_palindrome(s4)
    ...
    s5 = "aaaa"
    expected5 = "aaaa"
    result5 = solution.longest_palindrome(s5)
    ...
    result6 = solution.longest_palindrome(s6)
    ...
    s7 = "racecar"
    expected7 = "racecar"
    result7 = solution.longest_palindrome(s7)
    ...
    s8 = "abccba"
    expected8 = "abccba"
    result8 = solution.longest_palindrome(s8)
    ...
    s9 = "aabbaa"
    expected9 = "aabbaa"
    result9 = solution.longest_palindrome(s9)
    ...
    result10 = solution.longest_palindrome(s10)
    ...
    for s in test_cases:
        result1 = solution.longest_palindrome(s)
    ...
    s12 = ""
    expected12 = ""
    result12 = solution.longest_palindrome(s12)
    ...
    s13 = "12321"
    expected13 = "12321"
    result13 = solution.longest_palindrome(s13)
    ...
    s14 = "a1b2b1a"
    expected14 = "a1b2b1a"
    result14 = solution.longest_palindrome(s14)
    ...
    s15 = "xyzabccbaxyz"
    expected15 = "abccba"
    result15 = solution.longest_palindrome(s15)
