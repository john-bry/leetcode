...
class Solution:
    ...
    def checkInclusionMatchCount(self, s1: str, s2: str) -> bool:
        """
...
def test_solution():
    ...
    for s1, s2, expected in test_cases:
        ...
        result2 = solution.checkInclusionOptimized(s1, s2)
        result3 = solution.checkInclusionArray(s1, s2)
        result4 = solution.checkInclusionMatchCount(s1, s2)
    ...
    s2_11 = "a"
    expected11 = True
    result11 = solution.checkInclusion(s1_11, s2_11)
    ...
    s2_12 = "b"
    expected12 = False
    result12 = solution.checkInclusion(s1_12, s2_12)
    ...
    s2_13 = "ijhgfedcba"
    expected13 = True
    result13 = solution.checkInclusion(s1_13, s2_13)
    ...
    s2_14 = "ooolleoooleh"
    expected14 = False
    result14 = solution.checkInclusion(s1_14, s2_14)
    ...
    s2_15 = "bbbaaabbb"
    expected15 = True
    result15 = solution.checkInclusion(s1_15, s2_15)
